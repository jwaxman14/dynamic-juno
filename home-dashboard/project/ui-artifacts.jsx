...
function ArtifactBrowser({ projects, activeProjectId, setActiveProjectId, openArtifact, activeArtifactId }) {
  ...
  return (
    <aside className="rail rail--left">
      ...
      <div className="rail__footer rail__footer--left">
        <button type="button" className="ghost-btn">+ New project</button>
